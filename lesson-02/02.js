...
let dice1 = Math.floor(Math.random() * 6) + 1; // Генерация случайного числа от 1 до 6 для первого кубика
let dice2 = Math.floor(Math.random() * 6) + 1; // Генерация случайного числа от 1 до 6 для второго кубика
let isWinningDouble = (dice1 === dice2) && (dice1 > 3); // Проверка условий для выигрышного дубля
